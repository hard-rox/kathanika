...
public sealed class BaseRepositoryTests
{
    ...
    public async void GetById_Should_Return_With_Valid_Id()
    {
        ...
        // mockFindFluent.Setup(x => x.SingleOrDefaultAsync(default)).ReturnsAsync(dummy);
        ...
        _collectionMock.Verify(x => x.Find(It.IsAny<FilterDefinition<DummyEntity>>(), It.IsAny<FindOptions>()), Times.Once);
    }
}
