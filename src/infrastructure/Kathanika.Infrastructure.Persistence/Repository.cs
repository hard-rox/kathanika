...
internal abstract class Repository<T> : IRepository<T> where T : AggregateRoot
{
    ...
    protected Repository(IMongoDatabase database, string collectionName, ILogger<IRepository<T>> logger, ICacheService cacheService)
    {
    ...
    public async Task<T?> GetByIdAsync(string id, CancellationToken cancellationToken = default)
    {
        ...
        T document = await cursor.SingleOrDefaultAsync(cancellationToken: cancellationToken);
