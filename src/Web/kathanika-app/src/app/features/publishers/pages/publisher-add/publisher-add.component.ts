...
import { AddPublisherGQL, AddPublisherInput } from 'src/app/graphql/generated/graphql-operations';
...
export class PublisherAddComponent {
  @ViewChild('publisherAddForm') publisherAddForm: PublisherFormComponent | undefined;
