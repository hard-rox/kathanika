...
import { GetMembersQuery, GetMembersQueryVariables, MembershipStatus, GetMembersGQL } from '@kathanika/graphql-consumer';

@Component({
  templateUrl: './member-list.component.html',
  styleUrls: ['./member-list.component.scss']
})
export class MemberListComponent extends BasePaginatedListComponent<GetMembersQuery, GetMembersQueryVariables>
  implements OnInit {
