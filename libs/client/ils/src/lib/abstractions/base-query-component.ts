...
export abstract class BaseQueryComponent<TQuery, TQueryVariables extends OperationVariables>{
    ...
    protected set queryVariables(queryVariable: TQueryVariables | null | undefined) {
